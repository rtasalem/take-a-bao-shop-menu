...
import com.rtasalem.menuApi.exception.EventTitleExistsException;
...
public class EventsControllerAdvice {
	...
	@ExceptionHandler(value = EventTitleExistsException.class)
	public ResponseEntity<String> handleMenuItemNameExistsException(EventTitleExistsException ex) {
